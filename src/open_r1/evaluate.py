...
def aime_prompt_fn(line, task_name: str = None):
    ...
    if not hasattr(aime_prompt_fn, '_debug_count'):
        aime_prompt_fn._debug_count = 0

    if aime_prompt_fn._debug_count < 3:
        print("\n" + "="*80)
        print(f"AIME24 EXAMPLE {aime_prompt_fn._debug_count + 1}")
        print("="*80)
        print("INPUT QUERY:")
        print(query)
        print("\nGOLD ANSWER:")
